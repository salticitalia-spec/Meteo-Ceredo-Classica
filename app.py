...
# --- MOSTRO BOVINO INDEX (MODELLO 3 SETTORI: MANGIAFUOCO/TORRE/PECI) ---
def calcola_stato_parete(data_hist):
    try:
        pioggia_oraria = data_hist['hourly']['precipitation']
        # Coefficienti Bosco/Inerzia validati
    ...
    st.markdown(f"""
        <div class="forecast-card">
            ...
            <div style="display: flex; justify-content: space-between; margin-top: 8px;">
                <div style="text-align:center;"><span style="font-size: 9px; color: #555;">PIOGGIA</span>
