...
# --- 4. CSS (BLINDATO CONTRO BLOCCHI BIANCHI) ---
st.markdown('''
<style>
    ...
    h3 { color: white !important; font-weight: 100 !important; letter-spacing: 2px !important; text-transform: uppercase; }
</style>
...
if dhi and 'hourly' in dhi:
    ...
    st.line_chart(df_h, color=["#00FFFF", "#00FF00", "#
