...
try:
    ...
    curr_temp, curr_hum = curr["temperature"], dfc['hourly']['relativehumidity_2m'][now.hour]
...
alert_text = "🔥 AFA ELEVATA - GRIP SCARSO" if percepita > 30 else ("⚠️ RISCHIO CONDENSA VAJO" if curr_hum > 75 else "")
